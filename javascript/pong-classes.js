...
export class Game {
  constructor(
    ...
    this.size = { x: 900, y: 750 }; //container for entire game
...
export class Ball {
  constructor(
    ...
    this.acceleration = 6; //X speed multipler on successful block
    this.initial = { x: 2, y: 0 }; //speed reset on point score
    this.maximum = { x: 2, y: 1 }; //maximum speed
    this.inertialTransfer = 10.50; //multiplier for velocity.y transfer from paddle
    this.htmlElement = null; //element on HTML page
  }
}
