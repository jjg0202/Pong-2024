...
export var paddleSound = new soundFile("Wall Noise.mp3");
soundArray.push(paddleSound);

export var scoreSound = new soundFile("Score Noise.mp3");
soundArray.push(scoreSound);

export var ambientSound = new soundFile("PONG-Ambient Audio1.mp3");
...
villageMusic.player.volume.value = -3;
